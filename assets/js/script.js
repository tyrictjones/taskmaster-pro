...
// add datepicker to add task modal
...
$(".list-group").on("click", "span", function() {
  ...
  dateInput.datepicker({
    minDate: 1,
    onClose: function() {
      // closing [or clicking outside] the calendar forces a 'change' event on dateInput
      $(this).trigger("change");
    }
  });
...
// allow tasks to be dropped into the trash zone for deletion
$("#trash").droppable({
...
// use moment.js to see if due dates are upcoming or in the past
